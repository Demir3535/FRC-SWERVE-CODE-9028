...
public final class RobotConstants {
    public static final class DrivetrainConstants {
        ...
        public static final double DRIVE_BASE_RADIUS_METERS = 0.42; // measurement from center point of robot to the
                                                                       // center of one of the wheels. (use the CAD)

        public static final double LEFT_RIGHT_DISTANCE_METERS = Units.inchesToMeters(27); // Distance between centers of
                                                                                          // right
        // and left wheels on robot

        public static final double FRONT_BACK_DISTANCE_METERS = Units.inchesToMeters(27);// Distance between front and
                                                                                         // back
        // wheels on robot
    ...
    public static interface PortConstants {
        ...
        public static class Controller {
            public static final double JOYSTICK_AXIS_THRESHOLD = 0.2;  // aksisler
